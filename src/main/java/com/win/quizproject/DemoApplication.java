...
public class DemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		this.quizRepository.save(new Quiz("What Is Your Preferred Halloween Costume?", "None, I'm lame", "Skeleton",
				"George of the Jungle", "A group costume with friends", "Cow"));
		this.quizRepository.save(new Quiz("What Quality Is Most Attractive to You?", "Sense of humor", "Intelligence",
				"Thoughtfulness", "Great communication skills", "People who are unapologetically themselves"));
		this.quizRepository.save(new Quiz("What Is Your Karaoke Song?", "Mr. Brightside - The Killers",
				"Total Eclipse of The Heart - Bonie Tyler", "Summer Lovin' - Grease", "Fat Lip - Sum 41",
				"Cheeseburger in Paradise - Jimmy Buffett"));
		this.quizRepository.save(new Quiz("How Do You Celebrate Your Birthday?", "Dinner out", "Eating",
				"A vacation with my significant other", "A party with close friends and family", "With close friends"));
		this.quizRepository.save(new Quiz("What Is Your Biggest Pet Peeve?", "Lack of empathy",
		...
		this.quizRepository.save(new Quiz("If You Could Live Anywhere, Where Would It Be?", "Pacific Northwest",
				"Manhattan, NY", "Charlotte, NC", "Lima, Peru", "I'm happy with where I am and what I have"));
		this.quizRepository.save(new Quiz("What could you eat A LOT of?", "Potato chips", "Watermelon", "Pizza",
		...
		this.quizRepository.save(new Quiz("Danger's Afoot. No Time To Wait For Backup. What Do You Do?",
				"Call a friend", "Pick a hiding spot and observe the situation from a distance", "Evacuate!",
		...
		this.quizRepository.save(new Quiz("You Can Only Use One Social Network For the Rest of Your Life! What Is It?",
				"Twitter", "Stack Overflow", "Reddit", "The one I create on my own",
				"I don't really care about social media"));
		this.quizRepository.save(new Quiz("A Tornado Is Coming, Now What?", "Grab my kid, hide in bathtub",
		...
		this.quizRepository.save(new Quiz("What Would Make You Happiest On a Work Day?", "Go Home",
		...
		this.quizRepository.save(new Quiz("What's Your Motto to Live By?", "Work to live, don't live to work",
